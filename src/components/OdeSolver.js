...
function OdeSolver() {   
    ...
    //const [selectedVars1, setSelectedVars1] = useState([0, 0, 0]);
    //const [selectedVars2, setSelectedVars2] = useState([0, 0, 0]);
    //const [selectedVars3, setSelectedVars3] = useState([0, 0, 0]);
